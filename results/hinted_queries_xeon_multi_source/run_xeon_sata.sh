#!/bin/bash
# ============================================================
# HALO Xeon SATA Recommended Query Runner
# Target: Intel Xeon Silver 4310 + SATA Storage
# Generated: 2026-02-26
# ============================================================
#
# Usage:
#   chmod +x run_xeon_sata.sh
...
DB_JOB="imdbload"
TIMEOUT=900
RESULT_DIR="/root/halo_xeon_results/SATA"
SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"

mkdir -p "$RESULT_DIR/TPCH" "$RESULT_DIR/JOB"

echo "============================================================"
echo "HALO Xeon SATA Benchmark Runner"
echo "Started: $(date)"
...
for sql_file in "$SCRIPT_DIR/SATA/TPCH/"*.sql; do
...
for sql_file in "$SCRIPT_DIR/SATA/JOB/"*.sql; do
